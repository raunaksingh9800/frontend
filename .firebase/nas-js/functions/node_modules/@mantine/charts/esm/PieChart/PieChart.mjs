  ...
  return /* @__PURE__ */ jsx(Box, { ref, size, ...getStyles("root"), ...others, children: /* @__PURE__ */ jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxs(PieChart$1, { ...pieChartProps, children: [
    /* @__PURE__ */ jsx(
      Pie,
      {
        ...
        startAngle,
        endAngle,
        label: withLabels ? labelsPosition === "inside" ? getInsideLabel(labelsType || "value") : labelsType === "percent" ? ({ percent, x, y, cx, cy }) => /* @__PURE__ */ jsx(
          "text",
          {
            x,
            y,
            ...
            fontSize: 12,
            children: /* @__PURE__ */ jsx("tspan", { x, children: `${(percent * 100).toFixed(0)}%` })
          }
        ) : {
          fill: "var(--chart-labels-color, var(--mantine-color-dimmed))",
          fontSize: 12,
