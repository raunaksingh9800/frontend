...
const getInsideLabel = (labelsType) => ({ cx, cy, midAngle, innerRadius, outerRadius, value, percent }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "text",
    {
      ...
      children: labelsType === "percent" ? `${(percent * 100).toFixed(0)}%` : value
    }
  );
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(core.Box, { ref, size, ...getStyles("root"), ...others, children: /* @__PURE__ */ jsxRuntime.jsx(recharts.ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntime.jsxs(recharts.PieChart, { ...pieChartProps, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      recharts.Pie,
      {
        ...
        startAngle,
        endAngle,
        label: withLabels ? labelsPosition === "inside" ? getInsideLabel(labelsType || "value") : labelsType === "percent" ? ({ percent, x, y, cx, cy }) => /* @__PURE__ */ jsxRuntime.jsx(
          "text",
          {
            x,
            y,
            ...
            fontSize: 12,
            children: /* @__PURE__ */ jsxRuntime.jsx("tspan", { x, children: `${(percent * 100).toFixed(0)}%` })
          }
        ) : {
          fill: "var(--chart-labels-color, var(--mantine-color-dimmed))",
          fontSize: 12,
