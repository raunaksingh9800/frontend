  ...
  const bars = series.map((item) => {
    ...
    return /* @__PURE__ */ react.createElement(
      recharts.Bar,
      {
        ...
        label: withBarValueLabel ? /* @__PURE__ */ jsxRuntime.jsx(BarLabel, { valueFormatter }) : void 0,
        ...typeof barProps === "function" ? barProps(item) : barProps
      },
      inputData.map((entry, index) => /* @__PURE__ */ jsxRuntime.jsx(
        recharts.Cell,
        {
          fill: entry.color ? core.getThemeColor(entry.color, theme) : color
        },
        `cell-${index}`
      ))
    );
